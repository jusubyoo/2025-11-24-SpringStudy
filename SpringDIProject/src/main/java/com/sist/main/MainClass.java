 ...
 *   ------------------
 *       BeanFactory : core 만 지원 => Container/DI 제공
 *            |
 *    *** ApplicationContext : core + AOP (공통모듈) 지원
 *            | => AnnotationConfigApplicationContext (자바 전용)
 *   *** WebApplicationContext : core + AOP (공통모듈) + MVC 지원
 *   
 *   => 주입 => 생성/소멸 관리
 *             | new 를 사용하지 않고 컨테이너를 통해서 객체를 얻어서 사용
 *             | new 사용은 ~VO(데이터형)
 *   => 두가지 방식
 *      1) XML
 *      2) Annotation
